...
function SuperAdminCouponsPage() {
  ...
  const handleProductSelection = (productId: string) => {
    setSelectedProducts((prev) => {
      ...
      if (prev.length >= 8) {
        // Changed > 8 to >= 8 for better logic
        toast("You can select up to 8 products as featured");
        return prev;
      }
  ...
  const handleSaveChanges = async () => {
    ...
    if (result) {
      toast("Featured products updated successfully");
      featchFeaturedProducts();
    }
  };
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="space-y-6">
          <div>
            ...
            {/* Added a containing div for the uploaded files section to match the original structure */}
